...
impl RenderOnce for Checkbox {
    fn render(self, window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        // let base_color = if checked {
        //     cx.theme().primary
        // } else {
        //     cx.theme().foreground
        // };
        let base_color = cx.theme().foreground;
        // let bg = base_color.mix_oklab(cx.theme().transparent, 0.1);
        let bg = gpui::black().mix_oklab(cx.theme().transparent, 0.05);
        let hover = gpui::black().mix_oklab(cx.theme().transparent, 0.1);
        // let active = base_color.mix_oklab(cx.theme().transparent, 0.4);
        let border = base_color.mix_oklab(gpui::transparent_white(), 0.4);
        let hover_border = base_color.mix_oklab(gpui::transparent_white(), 0.6);
                        ...
                        .when(!checked, |this| {
                            this.child(
                                div()
                                    ...
                                    .items_center()
                                    .justify_center()
                                    .child(Icon::new(IconName::Check).map(|this| match self.size {
                                        Size::XSmall => this.size_2(),
                                        Size::Small => this.size_2p5(),
                                        Size::Medium => this.size_3(),
                                        Size::Large => this.size_3p5(),
                                    ...
                                    .hover(|s| {
                                        s.text_color(cx.theme().muted_foreground.alpha(0.5))
                                    }),
                            )
                        })
