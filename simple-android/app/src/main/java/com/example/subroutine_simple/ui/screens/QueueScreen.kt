...
import com.example.subroutine_simple.ui.components.QueueItemRow
            ...
            is ActionsUiState.Success -> {
                ...
                LazyColumn(
                    ...
                    items(
                        ...
                        QueueItemRow(
                            item = item,
                            isCompleting = item.id in completing,
                            onComplete = { viewModel.completeAction(item.id) },
                            onClickAction = { actionItem -> onEditAction(actionItem.action.id) },
                            onClickEvent = { eventItem -> onEditEvent(eventItem.event.id) },
                        )
                    }
